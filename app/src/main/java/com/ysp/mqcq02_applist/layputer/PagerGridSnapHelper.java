package com.ysp.mqcq02_applist.layputer;
...
import com.ysp.mqcq02_applist.layputer.PagerGridSmoothScroller;
...
public class PagerGridSnapHelper extends SnapHelper {
    ...
    public int[] calculateDistanceToFinalSnap(@NonNull RecyclerView.LayoutManager layoutManager,
        ...
        Log.e(TAG,"findTargetSnapPosition, pos = " + pos);
    ...
    public int findTargetSnapPosition(RecyclerView.LayoutManager layoutManager,
       ...
       Log.e(TAG,"findTargetSnapPosition, velocityX = " + velocityX + ", velocityY" + velocityY);
       ...
       Log.e(TAG,"findTargetSnapPosition, target = " + target);
        return target;
    }
    ...
    public boolean onFling(int velocityX, int velocityY) {
       ...
       Log.e(TAG,"minFlingVelocity = " + minFlingVelocity);
